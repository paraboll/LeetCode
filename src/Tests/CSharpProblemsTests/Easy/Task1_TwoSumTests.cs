...
namespace CSharpProblemsTests.Easy
{
    public class Task1_TwoSumTests
    {
        ...
        public void TwoSum1()
        {
            ...
            int target = 7;
            var numbers = new Task1_TwoSum().TwoSum(array, target);
        ...
        public void TwoSum3()
        {
            ...
            int target = 6;
            var numbers = new Task1_TwoSum().TwoSumAlgoritm(array, target);
        ...
        public void TwoSum4()
        {
            ...
            var numbers = new Task1_TwoSum().TwoPassHashTable(array, target);
        ...
        public void TwoSum7()
        {
            ...
            var numbers = new Task1_TwoSum().TwoPassHashTable1(array, target);
