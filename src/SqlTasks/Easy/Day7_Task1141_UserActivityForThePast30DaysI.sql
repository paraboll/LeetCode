...
--Create table Activity (user_id int, session_id int, activity_date date, activity_type nvarchar(100))
...
--Runtime: 3258 ms, faster than 7.82% of MS SQL Server online submissions for User Activity for the Past 30 Days I.
