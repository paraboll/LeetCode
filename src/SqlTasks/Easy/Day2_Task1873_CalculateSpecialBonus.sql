...
-- 	of an employee is 100% of their salary if the ID of the employee is 
-- 	an odd number and the employee name does not start with 
...
-- Runtime: 2515 ms, faster than 6.34% of MS SQL Server online submissions for Calculate Special Bonus.
...
-- Runtime: 1129 ms, faster than 76.81% of MS SQL Server online submissions for Calculate Special Bonus.
-- Memory Usage: 0B, less than 100.00% of MS SQL Server online submissions for Calculate Special Bonus.
SELECT 
    employee_id,
    CASE
