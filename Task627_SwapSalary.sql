...
-- Note that you must write a single update statement, do not 
...
-- To dynamically set a value to a column, we can use 
--  UPDATE statement together when CASE...WHEN... flow control statement.


-- Runtime: 383 ms, faster than 99.85% of MS SQL Server online submissions for Swap Salary.
