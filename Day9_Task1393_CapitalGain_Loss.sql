...
--SQL Schema:
--Create Table Stocks (stock_name varchar(15), operation varchar(10), operation_day int, price int)
...
--Runtime: 1460 ms, faster than 77.38% of MS SQL Server online submissions for Capital Gain/Loss.
...
--Runtime: 1981 ms, faster than 26.41% of MS SQL Server online submissions for Capital Gain/Loss.
--Memory Usage: 0B, less than 100.00% of MS SQL Server online submissions for Capital Gain/Loss.
